...
class EDSSpectraGUI(cw.FullscreenableWidget):
    def __init__(self, parent=None, icon_size=None,
        ...
        self._setup_toolbar()
        self.canvas = EDSCanvas(initial_mode=initial_mode)
    ...
    def _setup_toolbar(self):
        ...
        self.actionElementTable.setIcon(Qt.QIcon(self.gen_ico_path('pt.svg')))
        ...
        self.config_button.setIcon(
            Qt.QIcon(self.gen_ico_path('line_preview_settings.svg')))
        self._setup_config()
        ...
        self.actionMarker.setIcon(Qt.QIcon(self.gen_ico_path('lines.svg')))
    ...
    def _setup_auto(self):
        ...
        self.auto_all = Qt.QAction(Qt.QIcon(self.gen_ico_path('auto_all.svg')),
                                   'all',
                                   self.auto_button)
        self.auto_width = Qt.QAction(
            Qt.QIcon(self.gen_ico_path('auto_width.svg')),
            'width',
            self.auto_button)
        self.auto_height = Qt.QAction(
            Qt.QIcon(self.gen_ico_path('auto_height.svg')),
            'height',
            self.auto_button)
        self.auto_custom = Qt.QAction(
            Qt.QIcon(self.gen_ico_path('auto_custom.svg')),
            'custom',
            self.auto_button)
    ...
    def _setup_config(self):
        ...
        self.config_preview = Qt.QAction(
            Qt.QIcon(self.gen_ico_path('line_preview_settings.svg')),
            'preview style',
            self.config_button)
        self.config_burned = Qt.QAction(
            Qt.QIcon(self.gen_ico_path('line_burn_settings.svg')),
            'burned style',
            self.config_button)
