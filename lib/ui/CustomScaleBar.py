...
class AxisItem(GraphicsWidget):
    ...
    def __init__(self, orientation, pen=None, linkView=None, parent=None, maxTickLength=-5, showValues=True):
        ...
        **Arguments:**
        ...
        self.style = {
            'tickTextOffset': [5, 2],  ## (horizontal, vertical) spacing between text and axis #DELETE
            'tickTextWidth': 30,  ## space reserved for tick text  #DELETE
            'tickTextHeight': 18,   #DELETE
            'autoExpandTextSpace': True,  ## automatically expand text space if needed #DELETE
            'tickFont': None, #DELETE
            'stopAxisAtTick': (True, True),  ## whether axis is drawn to edge of box or to last tick 
